      ...
      <div class="flex justify-between items-center h-16">
        ...
        <router-link to="/" class="flex items-center space-x-3">
          <img
            :src="logoSrc"
            alt="Corsight AI"
            class="h-7 w-auto transition duration-300"
        ...
        <nav class="hidden md:flex items-center space-x-6">
          ...
          <!-- Globe Icon -->
          <button class="ml-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500 hover:text-indigo-600 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3C7 3 3 7 3 12s4 9 9 9 9-4 9-9-4-9-9-9z" />
            </svg>
          </button>
        </nav>
        ...
        <div class="flex items-center space-x-3">
          <!-- Partner Login -->
          <button class="hidden md:block border border-indigo-600 text-indigo-600 px-4 py-1 rounded-md hover:bg-indigo-50 transition">
            Partner Login
          </button>
...
const logoSrc = computed(() =>
  require('@/assets/images/Asset-2logowhite-1-2048x391.png')
)
